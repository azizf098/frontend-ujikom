        ...
        <footer class=" bg-white">
            <div class="mx-auto w-full max-w-screen-xl p-4 py-4 lg:py-4">
                ...
                <div class="sm:flex sm:items-center sm:justify-between">
                    <span class="text-sm text-green-500 sm:text-center dark:text-gray-400">© 2024 <a
                            href="https://flowbite.com/" class="hover:underline">GreenThumb</a>. All Rights Reserved.
                    </span>
